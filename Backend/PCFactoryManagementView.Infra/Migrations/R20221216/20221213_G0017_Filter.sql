	...
	VALUES ('WOHDCODE', 'WOHDCODE', 'FilterOptions','text', 'TABLETAB' , 1, '',0,1,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0017' AND
	...
	BEGIN
	INSERT INTO TBLScreenFields (TableName, FieldName,ComponentType,FieldType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField,IdScreen)
	VALUES ('CODEWOHD', 'CODEWOHD', 'FilterValues','text', 'WOHDCODE' , 1, '',0,1,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0017' AND
	IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
	END
	GO
	...
	BEGIN
	INSERT INTO TBLScreenFields (TableName, FieldName,ComponentType,FieldType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField,IdScreen)
	VALUES ('CODEWODET', 'CODEWODET', 'FilterValues','text', 'WOHDCODE' , 1, '',0,2,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0017' AND
	IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
	END
	GO