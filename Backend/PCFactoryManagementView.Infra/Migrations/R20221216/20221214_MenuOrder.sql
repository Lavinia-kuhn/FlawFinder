...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'H0001' AND ShortCut = 'H0001' GROUP BY MenuOrder) <> 27
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 27
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0127' AND ShortCut = 'G0127' GROUP BY MenuOrder) <> 52
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 52
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0128' AND ShortCut = 'G0128' GROUP BY MenuOrder) <> 53
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 53
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0129' AND ShortCut = 'G0129' GROUP BY MenuOrder) <> 54
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 54
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0131' AND ShortCut = 'G0131' GROUP BY MenuOrder) <> 55
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 55
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0132' AND ShortCut = 'G0132' GROUP BY MenuOrder) <> 56
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 56
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0133' AND ShortCut = 'G0133' GROUP BY MenuOrder) <> 57
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 57
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0134' AND ShortCut = 'G0134' GROUP BY MenuOrder) <> 58
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 58
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0135' AND ShortCut = 'G0135' GROUP BY MenuOrder) <> 59
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 59
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0137' AND ShortCut = 'G0137' GROUP BY MenuOrder) <> 60
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 60
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0144' AND ShortCut = 'G0144' GROUP BY MenuOrder) <> 61
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 61
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0146' AND ShortCut = 'G0146' GROUP BY MenuOrder) <> 62
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 62
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0149' AND ShortCut = 'G0149' GROUP BY MenuOrder) <> 63
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 63
