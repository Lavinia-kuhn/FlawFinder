...
-- --------------------------------------------------------------------------------------
--TELA G0127-Containers
IF NOT EXISTS (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0127'
...
BEGIN
                ...
                VALUES ('G0127', 'G0127–Containers', 'G0127–Containers', 1, (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View'), GETDATE(), 0)
...
IF NOT EXISTS (SELECT IDOperationScreen FROM TBLOperationScreen WHERE IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0127'
...
IF NOT EXISTS (SELECT IDProfileUserGroup FROM TBLProfileUserGroup WHERE IDOperationScreen = (
                ...
                SELECT IDOperationScreen FROM TBLOperationScreen WHERE IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0127'
...
IF NOT EXISTS (SELECT IDScreenMenu FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0127'
...
BEGIN
                ...
                VALUES ('VIEW_MENU_G0127', (SELECT IDScreenMenu FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_MATERIAIS'), 2, 1, 'G0127',

                (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0127'

                AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')), '/report/movmat/G0127')
...
--TELA G0127
IF NOT EXISTS (SELECT IDLocalization FROM TBLLocalizations WHERE TranslationKey = 'VIEW_MENU_G0127'

                AND IDApplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')

                AND IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0127' AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))

BEGIN

                INSERT INTO TBLLocalizations (PTLocal, ENLocal, ESLocal, FlgEnable, FlgProduct, TranslationKey, IDApplication, IDScreen)

                VALUES ('G0127-Containers','G0127-Containers', 'G0127-Containers',1,1,'VIEW_MENU_G0127',
...
BEGIN
                ...
                VALUES ('G0127', 'ReportTab', 'ReportTab', 'REPORT',1, 'TABLETAB',0,0,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0127' AND IDAplication = 
				(SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO
...
--REPORT / TIPO DE GRÁFICO OU TABELA - G0127
...
BEGIN
                ...
                VALUES ('G0127', 'table', 'ReportChart', 'TABLETAB' , 1, 'G0127/v1/Table',0,0,'', 
				(SELECT IDScreen FROM TBLScreen WHERE Code = 'G0127' AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')), 'tree')
END
GO