...
-- --------------------------------------------------------------------------------------
--TELA G0124-Ajuste de Unidade de Movimentação
IF NOT EXISTS (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124'
...
BEGIN
                ...
                VALUES ('G0124', 'G0124–Ajuste de Unidade de Movimentação', 'G0124–Inventory Moviment Adjustment', 1, (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View'), GETDATE(), 0)
...
IF NOT EXISTS (SELECT IDOperationScreen FROM TBLOperationScreen WHERE IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124'
...
BEGIN
                ...
                VALUES (
                               ...
                               (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124'
...
IF NOT EXISTS (SELECT IDProfileUserGroup FROM TBLProfileUserGroup WHERE IDOperationScreen = (
                ...
                SELECT IDOperationScreen FROM TBLOperationScreen WHERE IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124'
...
IF NOT EXISTS (SELECT IDScreenMenu FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0124'
...
BEGIN
                ...
                VALUES ('VIEW_MENU_G0124', (SELECT IDScreenMenu FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_MATERIAIS'), 49, 1, 'G0124',

                (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124'

                AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')), '/report/movmat/G0124')
...
--TELA G0124
IF NOT EXISTS (SELECT IDLocalization FROM TBLLocalizations WHERE TranslationKey = 'VIEW_MENU_G0124'

                AND IDApplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')

                AND IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124' AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))

BEGIN

                INSERT INTO TBLLocalizations (PTLocal, ENLocal, ESLocal, FlgEnable, FlgProduct, TranslationKey, IDApplication, IDScreen)

                VALUES ('G0124-Ajuste de Unidade de Movimentação','G0124–Inventory Moviment Adjustment', 'G0124-Ajuste de Movimentación de Inventario',1,1,'VIEW_MENU_G0124',
...
BEGIN
                ...
                VALUES ('G0124', 'ReportTab', 'ReportTab', 'REPORT',1, 'TABLETAB',0,0,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124' AND IDAplication = 
				(SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO
...
BEGIN
                INSERT INTO TBLScreenFields (TableName, FieldName,ComponentType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField,IdScreen)
                VALUES ('G0124', 'table', 'ReportChart', 'TABLETAB' , 1, 'G0124/v1/Table',0,0,'', 
				(SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124' AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO
...
BEGIN 
	...
	VALUES ('G0124', 'MainFilterUnMov', 'MainFilterUnMov', NULL, 'TABLETAB' , 0, '', 0, 0, '', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124' AND 
...
BEGIN 
	INSERT INTO TBLScreenFields (TableName, FieldName, ComponentType, FieldType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField, IdScreen)
	VALUES ('G0124', 'MainFilterMovType', 'MainFilterMovType', NULL, 'TABLETAB' , 0, '', 0, 0, '', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124' AND 
	IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO
...
BEGIN 
	INSERT INTO TBLScreenFields (TableName, FieldName, ComponentType, FieldType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField, IdScreen)
	VALUES ('G0124', 'MainFilterProductFamily', 'MainFilterProductFamily', NULL, 'TABLETAB' , 0, '', 0, 0, '', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124' AND 
	IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO
...
BEGIN 
	INSERT INTO TBLScreenFields (TableName, FieldName, ComponentType, FieldType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField, IdScreen)
	VALUES ('G0124', 'MainFilterDate', 'MainFilterDate', NULL, 'TABLETAB' , 0, '', 0, 0, '', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0124' AND 
	IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO