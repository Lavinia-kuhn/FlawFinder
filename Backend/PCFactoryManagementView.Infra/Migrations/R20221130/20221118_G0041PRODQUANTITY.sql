...
AND GroupName = 'PRODQUANTITYTABLETAB'
AND FieldName = 'CodeUnit'
AND TableName = 'CodeUnit'
AND FieldType = 'radio')
BEGIN
INSERT INTO TBLScreenFields (TableName, FieldName,ComponentType,FieldType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField,IdScreen)
VALUES ('CodeUnit', 'CodeUnit', 'FilterOptions','radio', 'PRODQUANTITYTABLETAB' , 1, '',0,1,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0041' AND
