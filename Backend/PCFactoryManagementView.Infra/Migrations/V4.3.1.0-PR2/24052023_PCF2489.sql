...
-- --------------------------------------------------------------------------------------
--TELA G0027–Tempo de Produção por Produto

IF NOT EXISTS (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027'
...
BEGIN
                ...
                VALUES ('G0027', 'G0027–Tempo de Produção por Produto', 'G0027–Production Time per Product', 1, (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View'), GETDATE(), 0)
...
IF NOT EXISTS (SELECT IDOperationScreen FROM TBLOperationScreen WHERE IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027'
...
BEGIN
                ...
                VALUES (
                               ...
                               (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027'
...
IF NOT EXISTS (SELECT IDProfileUserGroup FROM TBLProfileUserGroup WHERE IDOperationScreen = (
                ...
                SELECT IDOperationScreen FROM TBLOperationScreen WHERE IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027'
...
IF NOT EXISTS (SELECT IDScreenMenu FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0027'
...
BEGIN
                ...
                VALUES ('VIEW_MENU_G0027', (SELECT IDScreenMenu FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_PRODUCAO'), 19, 1, 'G0027',

                (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027'

                AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')), '/report/oee/G0027')
...
--TELA G0027
IF NOT EXISTS (SELECT IDLocalization FROM TBLLocalizations WHERE TranslationKey = 'VIEW_MENU_G0027'

                AND IDApplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')

                AND IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027' AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))

BEGIN

                INSERT INTO TBLLocalizations (PTLocal, ENLocal, ESLocal, FlgEnable, FlgProduct, TranslationKey, IDApplication, IDScreen)

                VALUES ('G0027-Tempo de Produção por Produtos','G0027-Production Time per Product', 'G0027-Tiempo de producción por producto',1,1,'VIEW_MENU_G0027',

                (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View'),

                (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027' AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
...
BEGIN
                ...
                VALUES ('G0027', 'ReportTab', 'ReportTab', 'REPORT',1, 'TABLETAB',0,1,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027' AND IDAplication = 
				(SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO
...
IF NOT EXISTS (SELECT IDScreenFields FROM TBLScreenFields WHERE IDScreen =
(SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027' AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View'))
AND ComponentType = 'ReportChart' AND DefaultValue = 'G0027/v1/Table')
BEGIN

                INSERT INTO TBLScreenFields (TableName, FieldName, ComponentType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField,IdScreen)
                VALUES ('G0027', 'table', 'ReportChart', 'TABLETAB',1, 'G0027/v1/Table',0,1,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027' AND IDAplication = 
				(SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO

-- ----------------------------------------- DETALHE DE FILTRO PARA QUANTIDADE DE ORDENS -----------------------------------------
IF NOT EXISTS (SELECT * FROM TBLScreenFields WHERE IDScreen =
(SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027' AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View'))
AND ComponentType = 'FilterOptions'
AND GroupName = 'TABLETAB'
AND FieldName = 'qtdOrder'
AND TableName = 'qtdOrder'
AND FieldType = 'checkbox')
BEGIN
INSERT INTO TBLScreenFields (TableName, FieldName,ComponentType,FieldType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField,IdScreen)
VALUES ('qtdOrder', 'qtdOrder', 'FilterOptions','text', 'TABLETAB' , 1, '',0,2,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027' AND
...
AND GroupName = 'qtdOrder'
AND FieldName = 'OrderQtd'
AND TableName = 'OrderQtd'
AND FieldType = 'text')
BEGIN
INSERT INTO TBLScreenFields (TableName, FieldName,ComponentType,FieldType, GroupName, [Enabled], DefaultValue, [Hidden], FieldOrder, CustomField,IdScreen)
VALUES ('OrderQtd', 'OrderQtd', 'FilterValues','text', 'qtdOrder' , 1, '',0,2,'', (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0027' AND
IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View')))
END
GO
...
IF EXISTS (
	SELECT 
		IDScreenMenu 
	FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0026'
		AND IDSuperiorScreenMenu = (
			SELECT 
				IDScreenMenu 
			FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_PRODUCAO'
			)
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0026' AND ShortCut = 'G0026' GROUP BY MenuOrder) <> 19
BEGIN
 UPDATE TBLScreenMenus
	SET MenuOrder = 19
 WHERE Code = 'VIEW_MENU_G0026' AND ShortCut = 'G0026'
 END
...
IF EXISTS (
	SELECT 
		IDScreenMenu 
	FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0027'
		AND IDSuperiorScreenMenu = (
			SELECT 
				IDScreenMenu 
			FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_PRODUCAO'
			)
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0027' AND ShortCut = 'G0027' GROUP BY MenuOrder) <> 20
BEGIN
 UPDATE TBLScreenMenus
	SET MenuOrder = 20
 WHERE Code = 'VIEW_MENU_G0027' AND ShortCut = 'G0027'
 END
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0029' AND ShortCut = 'G0029' GROUP BY MenuOrder) <> 21
BEGIN
 UPDATE TBLScreenMenus
	SET MenuOrder = 21
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0033' AND ShortCut = 'G0033' GROUP BY MenuOrder) <> 22
BEGIN
 UPDATE TBLScreenMenus
	SET MenuOrder = 22
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0041' AND ShortCut = 'G0041' GROUP BY MenuOrder) <> 23
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 23
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0043' AND ShortCut = 'G0043' GROUP BY MenuOrder) <> 24
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 24
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0050' AND ShortCut = 'G0050' GROUP BY MenuOrder) <> 25
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 25
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0099' AND ShortCut = 'G0099' GROUP BY MenuOrder) <> 26
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 26
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0100' AND ShortCut = 'G0100' GROUP BY MenuOrder) <> 27
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 27
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0103' AND ShortCut = 'G0103' GROUP BY MenuOrder) <> 28
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 28
...
IF EXISTS (
	SELECT 
		IDScreenMenu 
	FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0105'
		AND IDSuperiorScreenMenu = (
			SELECT 
				IDScreenMenu 
			FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_PRODUCAO'
			)
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0105' AND ShortCut = 'G0105' GROUP BY MenuOrder) <> 29
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 29
 WHERE Code = 'VIEW_MENU_G0105' AND ShortCut = 'G0105'
 END
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0150' AND ShortCut = 'G0150' GROUP BY MenuOrder) <> 30
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 30
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0151' AND ShortCut = 'G0151' GROUP BY MenuOrder) <> 31
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 31
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0152' AND ShortCut = 'G0152' GROUP BY MenuOrder) <> 32
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 32
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0153' AND ShortCut = 'G0153' GROUP BY MenuOrder) <> 33
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 33
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0154' AND ShortCut = 'G0154' GROUP BY MenuOrder) <> 34
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 34
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0155' AND ShortCut = 'G0155' GROUP BY MenuOrder) <> 35
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 35
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0156' AND ShortCut = 'G0156' GROUP BY MenuOrder) <> 36
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 36
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0157' AND ShortCut = 'G0157' GROUP BY MenuOrder) <> 37
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 37
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0138' AND ShortCut = 'G0138' GROUP BY MenuOrder) <> 38
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 38
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0140' AND ShortCut = 'G0140' GROUP BY MenuOrder) <> 39
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 39
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0141' AND ShortCut = 'G0141' GROUP BY MenuOrder) <> 40
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 40
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0142' AND ShortCut = 'G0142' GROUP BY MenuOrder) <> 41
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 41
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0143' AND ShortCut = 'G0143' GROUP BY MenuOrder) <> 42
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 42
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0145' AND ShortCut = 'G0145' GROUP BY MenuOrder) <> 43
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 43
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0147' AND ShortCut = 'G0147' GROUP BY MenuOrder) <> 44
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 44
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0148' AND ShortCut = 'G0148' GROUP BY MenuOrder) <> 45
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 45
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0160' AND ShortCut = 'G0160' GROUP BY MenuOrder) <> 46
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 46
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0012' AND ShortCut = 'G0012' GROUP BY MenuOrder) <> 47
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 47
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0014' AND ShortCut = 'G0014' GROUP BY MenuOrder) <> 48
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 48
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0016' AND ShortCut = 'G0016' GROUP BY MenuOrder) <> 49
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 49
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0017' AND ShortCut = 'G0017' GROUP BY MenuOrder) <> 50
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 50
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0018' AND ShortCut = 'G0018' GROUP BY MenuOrder) <> 51
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 51
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0125' AND ShortCut = 'G0125' GROUP BY MenuOrder) <> 52
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 52
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0126' AND ShortCut = 'G0126' GROUP BY MenuOrder) <> 53
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 53
...
IF EXISTS (
	SELECT 
		IDScreenMenu 
	FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0127'
		AND IDSuperiorScreenMenu = (
			SELECT 
				IDScreenMenu 
			FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_MATERIAIS'
			)
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0127' AND ShortCut = 'G0127' GROUP BY MenuOrder) <> 54
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 54
 WHERE Code = 'VIEW_MENU_G0127' AND ShortCut = 'G0127'
 END
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0128' AND ShortCut = 'G0128' GROUP BY MenuOrder) <> 55
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 55
...
IF EXISTS (
	SELECT 
		IDScreenMenu 
	FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0129'
		AND IDSuperiorScreenMenu = (
			SELECT 
				IDScreenMenu 
			FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_MATERIAIS'
			)
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0129' AND ShortCut = 'G0129' GROUP BY MenuOrder) <> 56
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 56
 WHERE Code = 'VIEW_MENU_G0129' AND ShortCut = 'G0129'
 END
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0131' AND ShortCut = 'G0131' GROUP BY MenuOrder) <> 57
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 57
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0132' AND ShortCut = 'G0132' GROUP BY MenuOrder) <> 58
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 58
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0133' AND ShortCut = 'G0133' GROUP BY MenuOrder) <> 59
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 59
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0134' AND ShortCut = 'G0134' GROUP BY MenuOrder) <> 60
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 60
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0135' AND ShortCut = 'G0135' GROUP BY MenuOrder) <> 61
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 61
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0137' AND ShortCut = 'G0137' GROUP BY MenuOrder) <> 62
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 62
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0144' AND ShortCut = 'G0144' GROUP BY MenuOrder) <> 63
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 63
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0146' AND ShortCut = 'G0146' GROUP BY MenuOrder) <> 64
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 64
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0149' AND ShortCut = 'G0149' GROUP BY MenuOrder) <> 65
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 65
