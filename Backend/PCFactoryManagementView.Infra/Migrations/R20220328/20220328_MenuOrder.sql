...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'H8001' AND ShortCut = 'H8001' GROUP BY MenuOrder) <> 24
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 24
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0150' AND ShortCut = 'G0150' GROUP BY MenuOrder) <> 25
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 25
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0151' AND ShortCut = 'G0151' GROUP BY MenuOrder) <> 26
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 26
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0152' AND ShortCut = 'G0152' GROUP BY MenuOrder) <> 27
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 27
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0153' AND ShortCut = 'G0153' GROUP BY MenuOrder) <> 28
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 28
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0154' AND ShortCut = 'G0154' GROUP BY MenuOrder) <> 29
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 29
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0155' AND ShortCut = 'G0155' GROUP BY MenuOrder) <> 30
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 30
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0156' AND ShortCut = 'G0156' GROUP BY MenuOrder) <> 31
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 31
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0157' AND ShortCut = 'G0157' GROUP BY MenuOrder) <> 32
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 32
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0138' AND ShortCut = 'G0138' GROUP BY MenuOrder) <> 33
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 33
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0140' AND ShortCut = 'G0140' GROUP BY MenuOrder) <> 34
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 34
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0141' AND ShortCut = 'G0141' GROUP BY MenuOrder) <> 35
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 35
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0142' AND ShortCut = 'G0142' GROUP BY MenuOrder) <> 36
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 36
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0143' AND ShortCut = 'G0143' GROUP BY MenuOrder) <> 37
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 37
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0145' AND ShortCut = 'G0145' GROUP BY MenuOrder) <> 38
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 38
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0147' AND ShortCut = 'G0147' GROUP BY MenuOrder) <> 39
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 39
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0148' AND ShortCut = 'G0148' GROUP BY MenuOrder) <> 40
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 40
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0012' AND ShortCut = 'G0012' GROUP BY MenuOrder) <> 41
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 41
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0014' AND ShortCut = 'G0014' GROUP BY MenuOrder) <> 42
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 42
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0016' AND ShortCut = 'G0016' GROUP BY MenuOrder) <> 43
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 43
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0017' AND ShortCut = 'G0017' GROUP BY MenuOrder) <> 44
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 44
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0018' AND ShortCut = 'G0018' GROUP BY MenuOrder) <> 45
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 45
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0131' AND ShortCut = 'G0131' GROUP BY MenuOrder) <> 46
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 46
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0132' AND ShortCut = 'G0132' GROUP BY MenuOrder) <> 47
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 47
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0133' AND ShortCut = 'G0133' GROUP BY MenuOrder) <> 48
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 48
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0134' AND ShortCut = 'G0134' GROUP BY MenuOrder) <> 49
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 49
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0135' AND ShortCut = 'G0135' GROUP BY MenuOrder) <> 50
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 50
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0137' AND ShortCut = 'G0137' GROUP BY MenuOrder) <> 51
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 51
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0144' AND ShortCut = 'G0144' GROUP BY MenuOrder) <> 52
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 52
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0146' AND ShortCut = 'G0146' GROUP BY MenuOrder) <> 53
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 53
...
) AND (SELECT MenuOrder FROM TBLScreenMenus WHERE Code = 'VIEW_MENU_G0149' AND ShortCut = 'G0149' GROUP BY MenuOrder) <> 54
BEGIN
UPDATE TBLScreenMenus
	SET MenuOrder = 54
