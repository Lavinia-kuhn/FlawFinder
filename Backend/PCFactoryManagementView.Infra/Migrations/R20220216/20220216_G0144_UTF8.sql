...
IF EXISTS (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0144'

 AND IDAplication = (SELECT IDAplication FROM TBLAplication WHERE Code = 'PCF4View'))
 BEGIN
	UPDATE TBLScreen SET Name = 'G0144–Analítico de OM', NameEN = 'G0144–OM Analytics' where IDScreen = (SELECT IDScreen FROM TBLScreen WHERE Code = 'G0144'
